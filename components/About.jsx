        ...
        <section id="about" className="section--about">
            ...
            <div className="about--container">
                ...
                >
                    ...
                    <p>This summer, I am interning at <a href="https://www.symmetrylaser.com/" target="_blank"><strong>Symmetry Laser</strong></a> where I'll be using <a href="https://www.python.org/" target="_blank"><strong>Python</strong></a> to create applications and automate tasks.</p>
                </motion.div>
            </div>
        </section>
    )
